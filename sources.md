...
| LEG4_CBO_DEFICIT | US fiscal trajectory | Congressional Budget Office | https://www.cbo.gov/publication/61882 | Budget and Economic Outlook 2026-2036 (Feb 2026): FY26 $1.9T (5.5% GDP) → FY36 $3.1T (6.7% GDP); debt-to-GDP 99% (FY25) → 108% (FY30, breaches 1946 peacetime peak of 106.1%) → 120% (FY36) | 2026-05-12 | cited | high | Cleaned at `us_fiscal_trajectory.csv`. Direct CBO primary source. CBO's own publication describes FY2030 as a "new record" — first peacetime breach of the 1946 peak. Cited in Part 2 §2.2. |
| LEG4_DEBT_HISTORICAL | US federal debt held by public, % of GDP — annual historical series | FRED (Federal Reserve Bank of St. Louis) — primary; Multpl mirror — retrieval | https://fred.stlouisfed.org/series/FYPUGDA188S | Annual values 1946-2024 (1946 peak 106.1%, 1974 trough 23.2%, 2024 99.6%). FRED series ID FYPUGDA188S, "Gross Federal Debt Held by the Public as Percent of GDP". | 2026-05-15 | cited | high | Cleaned at `us_debt_to_gdp_1946_2036.csv` (historical rows). Direct FRED CSV blocked from this environment per LESSONS P11; pulled via Multpl mirror at https://www.multpl.com/u-s-federal-debt-percent/table/by-year (FRED-derived). Cited in Part 2 §2.2 (Chart 13). |
| LEG4_CBO_BASELINE | CBO Feb 2026 baseline projections — annual debt-to-GDP 2025-2036 | CBO primary + American Action Forum / CRFB summaries | https://www.cbo.gov/publication/61882 | Year-by-year anchor points: FY25 99% / FY26 101% / FY30 107.7% / FY36 120%. AAF cites CBO's own "new record" framing for FY2030. | 2026-05-15 | cited | high | Cleaned at `us_debt_to_gdp_1946_2036.csv` (projection rows). 4 anchor years are direct CBO; intermediate years (FY27/28/29/31-35) are linear interpolations between anchors and flagged `verified: false` in the CSV. Anchor-year sources: AAF https://www.americanactionforum.org/insight/highlights-of-cbos-february-2026-budget-and-economic-outlook/ and CRFB https://www.crfb.org/blogs/cbo-releases-february-2026-budget-and-economic-outlook. Cited in Part 2 §2.2 (Chart 13). |
